...
`static/update/update_1_0_to_1_1.sh`

Uso:

```bash
./static/update/update_1_0_to_1_1.sh [target.sqlite3] [reference_v1_1.sqlite3] [target.env] [reference_v1_1.env] [reference_v1_0.env_example]
```

Esempio pratico:

```bash
chmod +x static/update/update_1_0_to_1_1.sh
./static/update/update_1_0_to_1_1.sh \
  /percorso/istanza_1_0/db.sqlite3 \
  ./db.sqlite3 \
  /percorso/istanza_1_0/.env \
  ./.env \
  ./.env_example
```
...
* sincronizza i parametri applicativi dal DB di riferimento 1.1
* aggiorna le variabili `.env` obsolete e aggiunge quelle nuove della versione 1.1
